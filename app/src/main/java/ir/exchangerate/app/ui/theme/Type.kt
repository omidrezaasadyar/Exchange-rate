...
val AppTypography = Typography(
    displayLarge = TextStyle(fontFamily = SansFamily, fontWeight = FontWeight.Bold, fontSize = 36.sp),
    headlineSmall = TextStyle(fontFamily = SansFamily, fontWeight = FontWeight.SemiBold, fontSize = 22.sp),
    titleLarge = TextStyle(fontFamily = SansFamily, fontWeight = FontWeight.SemiBold, fontSize = 20.sp),
    ...
    labelMedium = TextStyle(fontFamily = SansFamily, fontWeight = FontWeight.Normal, fontSize = 12.sp),
)
